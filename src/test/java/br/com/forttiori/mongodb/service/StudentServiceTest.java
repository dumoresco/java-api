...
public class StudentServiceTest extends ApplicationConfigTest {
  ...
  public void shouldCreateAnStudent() {
    ...
    Mockito.when(studentRepository.save(Mockito.any()))
        .thenReturn(StudentCreator.studentEntityStub());
    Mockito.when(addressIntegration.consultaCep("91740840"))
        .thenReturn(StudentCreator.addressEntityStub());
  ...
  public void shouldReturnListOfStudents() {
    ...
    Mockito.when(studentRepository.findAll())
        .thenReturn(
            List.of(
                StudentCreator.studentEntityStub(),
  ...
  public void shouldReceiveAnIdThenReturnCorrespondentUser() {
    ...
    Mockito.when(studentRepository.findById(Mockito.anyString()))
        .thenReturn(Optional.ofNullable(StudentCreator.studentEntityStub()));
    // When
  ...
  void shouldReceiveAListOfIdsAndDeleteSpecifiedUsers() {
    ...
    studentService.deleteAll(
        List.of(
            StudentCreator.studentEntityStub().getId(),
  ...
  void shoulUpdateAnSpecifiedUser() {
    ...
    studentService.updateStudent(
        StudentCreator.studentEntityStub().getId(), StudentCreator.studentRequestStub());
    //      THEN
  ...
  public void ShouldReturnAnListOfStudentsFiltered() {
